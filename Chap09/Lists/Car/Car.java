...
public class Car {
	 ...
	 * 作成日：2024/05/09
	*/
	public Car(String carName, String carNumber, int carWidth, int carHeight, int carLength, double remainingFuel,
			double fuelConsumption, double tankCapacity, Day purchaseDay) {
		//車の名前のインスタンスを初期化
