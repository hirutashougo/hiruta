package Chap10.Exercises.Ex10_04_ver2;
...
public class DayTester {
	...
	*/
	public static void main(String[] args) {
		...
		do {
			//処理の説明
			System.out.println("1日後の日付を表示します。\n");
		...
		do {
			//処理の説明
			System.out.println("1日前の日付を表示します。\n");
		...
		do {
			//処理の説明
			System.out.println("数日後の日付を表示します。\n");
			...
			System.out.println("\n" + advanceCount +"日後の日付：" + assignmentDay);
		...
		do {
			...
			System.out.println("\n" + returnCount + "日後の日付：" + assignmentDay);
